...
class Car:
    def __init__(self,
        ...
        self.name = name
        self.price = price
        self.fuel_economy = fuel_economy #расходбензина
        self.service_cost = service_cost
        self.insurance_cost = insurances_cost
...
class ElectricCar(Car):
    def __init__(self, name: str, price: int, fuel_economy: float, service_cost: int, insurances_cost: int, power_consumption: int):
        super().__init__(name = name, price=price, fuel_economy=0, service_cost=0, insurances_cost=insurances_cost)
